	...
	<div class="container">
		<div class="col-10 m-auto">
			<form:form modelAttribute="order" method="post">
				...
				<button type="submit" formaction="/checkout" class="btn btn-primary">Check
					out</button>
			</form:form>
		</div>
		<table class="table">
			...
			<tbody>
				<c:forEach items="${card }" var="i">
					<tr>
						<th scope="row">${i.product.title }</th>
						<th scope="row"><img alt="" src="${i.product.image }"
							width="150px" height="50px"></th>
						<th scope="row"><input name="soluong" type="number"
							value="${i.quantity }" min="1"></th>
						<th scope="row">${i.product.price }</th>
						<th scope="row">${i.product.price * i.quantity }</th>
		...
		<h3 style="float: right;">Tổng tiền ${total}</h3>
